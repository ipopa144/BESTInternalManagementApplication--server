...
public class NotificationController {
    ...
    @PostMapping("/send")
    public ResponseEntity<NotificationUsersDTO> sendNotification(@RequestBody NotificationDTO notificationDTO,
                                                                 @RequestHeader("Authorization") String jwtToken) {

        User user = userService.identifyUser(jwtToken);

        Notification savedNotification = notificationService.save(notificationDTO, user);
        ...
        NotificationUsersDTO notificationUsersDTO = new NotificationUsersDTO(savedNotification, selectedUserForNotification);
